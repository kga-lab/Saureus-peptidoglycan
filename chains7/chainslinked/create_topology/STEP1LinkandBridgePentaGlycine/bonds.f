!======================================================================!
            open(88,file='inputs/NAG_NAM_periodiclinks.tex') !chain numbers for pbclink
            read(88,*) comment
            open(87,file='inputs/newbonds_ordered.dat') !LYS-->GLY
           !----------------[ bonds ]------------------------!
             write(32,'(a)') ''
             write(32,'(a)') '[ bonds ]'
            ...
            do ic=1,Nc
             do kr=1,Nr(ic)
                 ...
                 enddo
                 ca = ca + Nar(kr,ic)
                 if(trim(resnam(kr,ic)).ne.'GLY')then
                  close(fp)
                 endif
             enddo
           enddo
